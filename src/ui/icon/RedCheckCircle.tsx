...
import { deepOrange500 } from 'Src/app/style/variables'

import SvgIcon, { Props } from './SvgIcon'


export default class RedCheckCircle extends React.Component<Props> {

    render() {
        return (
            // Original: FaCheckCircle (but with a white check)
            <SvgIcon viewBox='0 0 512 512' {...this.props}>
